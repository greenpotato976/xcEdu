...
//        commend.add("D:\\BaiduNetdiskDownload\\test1.avi");
    ...
    public static void main(String[] args) throws IOException {
        String ffmpeg_path = "G:/Javaresource/environment/ffmpeg/ffmpeg-20180227/bin/ffmpeg.exe";//ffmpeg的安装位置
        String video_path = "G:\\Javaresource\\xuecheng\\lucene.avi";
        String mp4_name = "lucene.mp4";
        String mp4_path = "G:\\Javaresource\\xuecheng\\";
